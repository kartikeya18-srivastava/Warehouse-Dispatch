...
const StatCard = ({ title, value, subValue, trend, trendType }: any) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            data?.recentActivity?.map((activity: any, idx: number) => (
                                <div key={idx} className="py-4 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-500 font-bold">
                                            {activity.type?.[0] || 'A'}
                                        </div>
                                        <div>
                ...
                <Card title="Fleet Status">
                    <div className="space-y-6">
                        {data?.driverUtilization?.map((driver: any, idx: number) => (
